"""Lightning module for ViT-B/16 baseline."""
...
class LitViT(pl.LightningModule):
    """Train/eval wrapper for the ViT-B/16 baseline."""
    ...
    def __init__(self, model_cfg: dict[str, Any], optim_cfg: dict[str, Any]) -> None:
        ...
        self.model = ViTB16Classifier(
            backbone_name=str(model_cfg.get("backbone_name", "vit_base_patch16_224")),
