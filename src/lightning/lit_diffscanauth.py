"""Lightning module for the full DiffScanAuth model."""
...
class LitDiffScanAuth(LitSequentialBase):
    """Full DiffScanAuth training wrapper."""
    ...
    def __init__(self, model_cfg: dict[str, Any], optim_cfg: dict[str, Any]) -> None:
        model = DiffScanAuth(
            ...
            scheduled_sampling_ratio=float(model_cfg.get("scheduled_sampling_ratio", 0.0)),
        ...
        super().__init__(
            ...
            model_cfg=model_cfg,
            optim_cfg=optim_cfg,
            use_gaze_supervision=bool(model_cfg.get("use_gaze_supervision", True)),
            use_teacher_distill=bool(model_cfg.get("use_teacher_distill", True)),
        )
